...
const SectionTemplateLeftRight = ( { sectionTitle, title, description, link, content } ) => {
    return (
        <div className="w-full h-auto flex flex-col mt-8 xl:mt-40 py-4">
            ...
            <div className="w-full flex flex-row flex-wrap">
                <div className="w-full xl:w-1/2 flex flex-col justify-between items-start xl:pr-2">
                ...
                <div className="w-full xl:w-1/2 pl-0 xl:pl-2 mt-4 xl:mt-0">
                    {content}
                </div>
            </div>
        </div>
...
export default SectionTemplateLeftRight
